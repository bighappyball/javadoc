...
![DispatcherServlet类图](../../../_media/spring/analysis/DispatcherServlet.jpg)
...
![ApplicationContextInitializer类图](../../../_media/spring/analysis/ApplicationContextInitializer.jpg)
...
![XmlWebApplicationContext类图](../../../_media/spring/analysis/XmlWebApplicationContext.jpg)
...
![mvc-annotation](../../../_media/spring/analysis/mvc-annotation.png)
...
![MultipartResolver类图](../../../_media/spring/analysis/MultipartResolver.jpg)
...
![ThemeResolver类图](../../../_media/spring/analysis/ThemeResolver.jpg)
...
![RequestToViewNameTranslator类图](../../../_media/spring/analysis/RequestToViewNameTranslator.jpg)
...
![FlashMapManager类图](../../../_media/spring/analysis/FlashMapManager.jpg)
...
![RequestMappingHandlerMapping类图](../../../_media/spring/analysis/RequestMappingHandlerMapping.jpg)
...
![MappingRegistry类图](../../../_media/spring/analysis/MappingRegistry.jpg)
...
![HandlerMethodMappingNamingStrategy类图](../../../_media/spring/analysis/HandlerMethodMappingNamingStrategy.jpg)
...
![MappedInterceptor类图](../../../_media/spring/analysis/MappedInterceptor.jpg)

## HandlerAdapter初始化

同样，我们以RequestMappingHandlerAdapter为例进行说明，类图:

![RequestMappingHandlerAdapter类图](../../../_media/spring/analysis/RequestMappingHandlerAdapter.jpg)
...
![HandlerMethodArgumentResolver类图](../../../_media/spring/analysis/HandlerMethodArgumentResolver.jpg)
...
![HandlerMethodReturnValueHandler类图](../../../_media/spring/analysis/HandlerMethodReturnValueHandler.jpg)
...
![ParameterNameDiscoverer](../../../_media/spring/analysis/ParameterNameDiscoverer.jpg)
...
![本地变量表](../../../_media/spring/analysis/local_variable_tables.PNG)

但是默认情况下javac compiler是不生成本地变量表这种调试信息的，需要加`-g`参数才可以，那为什么在我们的测试Controller中却可以获得呢，玄机就在于idea的下列设置:

![idea编译设置](../../../_media/spring/analysis/idea_debug_info.PNG)

取消这项设置的勾选再次运行程序便出问题了:

![调试信息错误](../../../_media/spring/analysis/debug_info_error.PNG)
...
![BindingAwareModelMap类图](../../../_media/spring/analysis/BindingAwareModelMap.jpg)
...
![ModelAndView类图](../../../_media/spring/analysis/ModelAndView.jpg)
...
![ViewResolver类图](../../../_media/spring/analysis/ViewResolver.jpg)
...
![JstlView类图](../../../_media/spring/analysis/JstlView.jpg)
...
![HttpMessageConverter](../../../_media/spring/analysis/HttpMessageConverter.jpg)
...
![Spring MVC输入输出转换](../../../_media/spring/analysis/mvc_input_output.PNG)

HandlerMethodArgumentResolver接口及其主要实现类如下图:

![HandlerMethodArgumentResolver](../../../_media/spring/analysis/HandlerMethodArgumentResolver_all.jpg)

HandlerMethodReturnValueHandler接口以及主要实现类如下:

![HandlerMethodReturnValueHandler](../../../_media/spring/analysis/HandlerMethodReturnValueHandler_all.jpg)
...
![ServletModelAttributeMethodProcessor](../../../_media/spring/analysis/ServletModelAttributeMethodProcessor.jpg)
...
![DataBinder](../../../_media/spring/analysis/DataBinder.jpg)

WebDataBinderFactory接口用以创建WebDataBinder对象，其继承体系如下图:

![WebDataBinderFactory](../../../_media/spring/analysis/WebDataBinderFactory.jpg)
...
![Validator](../../../_media/spring/analysis/Validator.png)
