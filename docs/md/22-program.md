...
便捷的获取患者病历资料，解耦 所以独立一套自动获取引擎服务，前置机部署。
...
服务器配置 8台 8h16g，其中 mysql mq redis zooker 3台  业务配置4台  引擎3台 

并发  

高峰qps 2w+  日pv 300w+  用户200w 医生2w+ 机构100+ 日活跃用户10w+
...
>[MySQL并发时经典常见的死锁原因有哪些 - MySQL数据库 - 亿速云 (yisu.com)](https://www.yisu.com/zixun/261552.html)

## mianjing

灰豚

1、负责根据开发进度和任务分配，完成相应模块的开
发任务，并在过程中解决关键问题和技术难题
2、负责参与需求分析、设计，高质量完成开发任务确保高性能处理和系统的稳定性;
3、参与软件工程文档、产品文档的编写
任职要求
3年以上JAVA开发经验 ，计算机或相关专业，全日制统招本科(硬性要求谢谢!)
JAVA基础扎实，理解10、多线程、集合等基础框架对JVM原理有一定的了解;
熟悉软件开发，Maven配置管理工具，具有良好的编程习惯;
对高并发、高稳定可用性、高性能、大数据处理有过实际项目产品经验者优先。
