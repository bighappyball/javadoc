...
![这里写图片描述](../_media/netty1/SouthEast.png)
...
![img](../_media/netty1/wps34B.tmp.jpg) 
...
G1回收器和CMS比起来，有以下不同：![img](../_media/netty1/wps34C.tmp.jpg)
...
![图片](../_media/netty1/640.png)

监控系统调出图表查看：

![图片](../_media/netty1/640-1676439035395-3.png)
