...
![图片](../_media/network/640-1691462666330-3.png)
...
![图片](../_media/network/640-1691462750125-6.png)
...
![图片](../_media/network/640-1691462755485-9.png)
...
![图片](../_media/network/640-1691462764981-12.png)
...
![图片](../_media/network/640-1691462774123-15.png)
...
![图片](../_media/network/640-1691462780673-18.png)
...
![图片](../_media/network/640-1691462876837-21.png)**ELF文件格式**
...
![图片](../_media/network/640-1691462899467-24.png)分别为宏内核、微内核、混合内核的操作系统结构
...
CPU利用率：和负载不同，CPU利用率指的是当前正在运行的进程实时占用CPU的百分比，他是对一段时间内CPU使用状况的统计（如果在1个小时内，A上厕所花了10分钟，B上厕所花了20分钟，剩下30分钟厕所都没人使用，那么这一个小时内利用率就是50%）。
...
![图片](../_media/network/640-1691473393720-27.png)
...
![图片](../_media/network/640-1691473406108-30.png)
...
![图片](../_media/network/640-1691474452038-33.png)
...
![图片](../_media/network/640-1691474637308-36.png)
...
![图片](../_media/network/640-1691474685844-39.png)
...
![图片](../_media/network/640-1691475475627-42.png)
...
​                 ![img](../_media/network/MTY4ODg1MTI2MTkxMzIyMQ_253992_MOUWAWqE75A37YJ3_1658736801.png)        
...
![在这里插入图片描述](../_media/network/https.jpeg)
...
另外，在HTTPS的场景中只有服务端保存了私钥，一对公私钥只能实现单向的加解密，所以 HTTPS 中内容传输加密采取的是对称加密，而不是非对称加密。
...
![image-20230808150946839](../_media/network/image-20230808150946839.png)
...
![image-20230808151043656](../_media/network/image-20230808151043656.png)
...
![图片](../_media/network/640-1691477357749-61.png)
...
说直白点，为什么单线程能够处理的却要用多线程来处理？当然是为了提高程序的装逼并行能力了。多线程在某些情况下能够使你程序运行的更快，这也是为什么多核 CPU 会出现，但是多核 CPU 的出现会导致数据的一致性问题，不过这些问题程序员就能解决。另一个角度来说，多线程编程能够提高程序员的编程能力和编程思维。同时也能提高程序员的管理能力，你如果把每条线程流当作罗老师时间管理的女主一样，能够及时协调好所有 P 友的关系，那你也是超神程序员了，所以，是谁说程序员不会做管理的？
...
![图片](../_media/network/640-1691476904962-58.png)
...
![图片](../_media/network/640-1691476893929-55.png)
...
1. CPU 使用率：CPU 正在执行任务（即不处于空闲状态）的时间百分比。
...
连接结束      ![img](../_media/network/MTY4ODg1MTI2MTkxMzIyMQ_986697_VLJBuYhoOi9ELoWE_1657075859.png)        
