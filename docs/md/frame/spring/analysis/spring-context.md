...
![Comparator继承体系](../../../_media/spring/analysis/Comparator.jpg)
...
![ContextAnnotationAutowireCandidateResolver类图](../../../_media/spring/analysis/ContextAnnotationAutowireCandidateResolver.jpg)

### ConfigurationClassPostProcessor

此类用于处理标注了@Configuration注解的类。类图:

![ConfigurationClassPostProcessor类图](../../../_media/spring/analysis/ConfigurationClassPostProcessor.jpg)

### AutowiredAnnotationBeanPostProcessor

此类便用于对标注了@Autowire等注解的bean或是方法进行注入。

![AutowiredAnnotationBeanPostProcessor类图](../../../_media/spring/analysis/AutowiredAnnotationBeanPostProcessor.jpg)
...
![CommonAnnotationBeanPostProcessor类图](../../../_media/spring/analysis/CommonAnnotationBeanPostProcessor.jpg)
...
![EventListenerMethodProcessor类图](../../../_media/spring/analysis/EventListenerMethodProcessor.jpg)

### DefaultEventListenerFactory

此类应该是和上面的配合使用，用以产生EventListener对象，也是从Spring4.2加入，类图:

![DefaultEventListenerFactory类图](../../../_media/spring/analysis/DefaultEventListenerFactory.jpg)
...
![CompositeComponentDefinition类图](../../../_media/spring/analysis/CompositeComponentDefinition.jpg)

最终形成的数据结构如下图:

![数据结构](../../../_media/spring/analysis/context_annotation_stack.png)
...
![ImportAwareBeanPostProcessor类图](../../../_media/spring/analysis/ImportAwareBeanPostProcessor.jpg)
...
![BeanNameGenerator类图](../../../_media/spring/analysis/BeanNameGenerator.jpg)
...
![@Required测试](../../../_media/spring/analysis/@required_test.png)
...
![ScopeMetadataResolver类图](../../../_media/spring/analysis/ScopeMetadataResolver.jpg)
...
![MetadataReader类图](../../../_media/spring/analysis/MetadataReader.jpg)
...
![AnnotationMetadataReadingVisitor类图](../../../_media/spring/analysis/AnnotationMetadataReadingVisitor.jpg)
...
![ScannedGenericBeanDefinition类图](../../../_media/spring/analysis/ScannedGenericBeanDefinition.jpg)
...
![PropertyOverrideBeanDefinitionParser类图](../../../_media/spring/analysis/PropertyOverrideBeanDefinitionParser.jpg)
...
![PropertyOverrideConfigurer类图](../../../_media/spring/analysis/PropertyOverrideConfigurer.jpg)
...
![PropertySourcesPlaceholderConfigurer类图](../../../_media/spring/analysis/PropertySourcesPlaceholderConfigurer.jpg)
...
![LoadTimeWeaver继承体系](../../../_media/spring/analysis/LoadTimeWeaver.jpg)
...
![AspectJWeavingEnabler类图](../../../_media/spring/analysis/AspectJWeavingEnabler.jpg)
...
![AnnotationBeanConfigurerAspect类图](../../../_media/spring/analysis/AnnotationBeanConfigurerAspect.jpg)
...
![LoadTimeWeaverAwareProcessor类图](../../../_media/spring/analysis/LoadTimeWeaverAwareProcessor.jpg)
...
![ClassPreProcessorAgentAdapter类图](../../../_media/spring/analysis/ClassPreProcessorAgentAdapter.jpg)
...
![aop.xml解析结果](../../../_media/spring/analysis/aop_xml_parse.png)
